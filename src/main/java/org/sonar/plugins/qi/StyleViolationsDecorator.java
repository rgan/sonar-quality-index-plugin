...
public class StyleViolationsDecorator extends AbstractViolationsDecorator {
    ...
    public static final String STYLECOP_PLUGIN = "stylecop";
    ...
    public boolean includeRule(Rule rule) {
        ...
        return pluginName.equalsIgnoreCase(STYLECOP_PLUGIN) ||
                    pluginName.equals(CoreProperties.CHECKSTYLE_PLUGIN);
    }
}
